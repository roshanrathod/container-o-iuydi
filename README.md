...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o-iuydi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o-iuydi.containers.anotherwebservice.com/
...
```
git clone git@github.com:roshanrathod/container-o-iuydi.git
cd container-o-iuydi
```
...
```
docker attach container-o-iuydi
```
